      ...
      >
        <div className="p-8 sm:p-10">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-[28px] font-bold text-[#1a1a1a] tracking-tight">Join Kanflow</h1>
            <p className="text-[#666666] mt-1 text-[15px]">Start managing your tasks and projects efficiently today.</p>
          </div>
